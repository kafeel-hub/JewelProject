...
const CustomInput = ({ label, name, type = "text", value, onChange, error }) => (
  <TextField
    fullWidth
    label={label}
    name={name}
...
const TableInput = ({ label, name, type = "text", value, onChange, error }) => {
  const handleChange = (event) => {
    ...
    if (type === "number") {
      const numericValue = inputValue === "" || !isNaN(inputValue) ? inputValue : value; x
...
export {CustomInput,CustomSelect,CustomDatePicker,TableInput} ;
